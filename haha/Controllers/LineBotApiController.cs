...
namespace haha.Controllers
{
    ...
    public class LineBotApiController : ControllerBase
    {
        ...
        public LineBotApiController(IConfiguration Configuration)
        {
        ...
        public async Task<IActionResult> POST()
        {
            try
            {
                ...
                //建立Bot instance
                isRock.LineBot.Bot bot = new isRock.LineBot.Bot(_Configuration["LineBot:accessToken"]);  //傳入Channel access token
                ...
                switch (UserSays.ToLower())
                {
                    ...
                    case "圖片":
                        ...
                        bot.ReplyMessage(_Configuration["LineBot:accessToken"], new isRock.LineBot.TemplateMessage(CarouselTemplate));
                    ...
                    case "carouseltemplate":
                        ...
                        //發送
                        //bot.PushMessage(UserID, CarouselTemplate);
                        bot.ReplyMessage(_Configuration["LineBot:accessToken"], new isRock.LineBot.TemplateMessage(CarouselTemplate1));
                        break;
