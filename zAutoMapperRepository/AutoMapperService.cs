    ...
    public static class AutoMapperService
    {
        public static IServiceCollection AddAutoMapperService(this IServiceCollection service)
        {
            service.AddAutoMapper(cfg => {
                cfg.AddProfile<ContainerMapperProfile>();
                cfg.AddProfile<ProductMapperProfile>();
                cfg.AddProfile<CategoryMappProfile>();

            },AppDomain.CurrentDomain.GetAssemblies(),serviceLifetime: ServiceLifetime.Singleton);
